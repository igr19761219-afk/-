...
async def send_products_and_recommendations(update_or_query, context):
    ...
    text = (
        ...
        f"Один из моих партнёров просто оформил накопительный счёт, чтобы откладывать на ремонт. Через год он накопил нужную сумму и сказал: «Если бы не эта карта, я бы всё потратил».\n\n"
...
async def help_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    help_text = (
        ...
        "/mycandidates – список кандидатов, ожидающих подтверждения.\n"
        ...
        "/makeinactive [id] – перевести в неактивные (исключить из догревов).\n"
